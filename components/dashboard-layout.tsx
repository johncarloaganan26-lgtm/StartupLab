...
import { Ticket, BarChart3, ScrollText } from 'lucide-react';
...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="font-roboto flex h-screen bg-muted/40 text-foreground transition-colors duration-300">
      <UserSidebar isCollapsed={isCollapsed} />
      <main className="flex-1 overflow-auto flex flex-col">
        <div className="pointer-events-none fixed inset-0 z-0 hidden items-end justify-center pb-12 print:flex">
          <img
